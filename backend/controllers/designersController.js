...
// //Get Designer Details (The current Logged in designer details)
// exports.getLoggedDesignerDetails = catchAsyncError(async (req, res, next) => {
//   const designer = await User.findById(req.designer.id);
